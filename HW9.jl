...
function trajectory(c::Coordinate, n::Int, L::Number)
	...
	return accumulate((x, y)->collide_boundary(x+y,L), rand(possible_moves,n), init=c)
end
...
md"""
L = $(@bind L Slider(10:20, default=10, show_value=true))
"""

# ╔═╡ 1de70a5a-4ef8-437a-940e-b47887cbd944
@bind button Button("Re-run")

# ╔═╡ fd49d753-1087-4e42-938e-1230d6302d67
let
	button
	p = plot(ratio=1)
	plot_trajectory!(p, trajectory(Coordinate(4,4), 1000, L); color="black")
	p
end
